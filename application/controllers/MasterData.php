...
class MasterData extends CI_Controller
{
    ...
    public function list_petugas()
    {
        ...
        foreach ($data as $petugas) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $petugas->ID_PETUGAS . '" class="btn btn-sm btn-success" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
                <a href="' . base_url('masterdata/petugas_del/') .  $petugas->ID_PETUGAS . '" class="btn btn-sm btn-warning tombol-hapus"><i class="fas fa-trash"></i></a>
                </td>';
            echo '</tr>';
            echo "<script>
    ...
    public function list_siswa()
    {
        ...
        foreach ($data as $siswa) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $siswa->NISN . '" class="btn btn-sm btn-warning" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
                <a href="' . base_url('masterdata/siswa_del/') .  $siswa->NISN . '" class="btn btn-sm btn-danger tombol-hapus"  id="delete" name="delete"><i class="fas fa-trash"></i></a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    // //    cek apakah data di tabel terkait masih ada yang menggunakan nilai ID ini
    //     $cek = $this->db->get_where('tbl_pembayaran', ['id_siswa' => $id]);
    //     if ($cek->num_rows() >0) {
    //         // ada data terkait, rollback transaksi dan hentikan proses penghapusan 
    //         $this->db->trans_rollback();
    //         $this->session->set_flashdata(
    ...
    public function siswa_del($id)
    {
        ...
        if ($this->db->trans_status() == false) {
            $this->session->set_flashdata(
                'info',
                '<div class="alert aler-danger" role"alert">Gagal diubah</div>'
            );
            redirect('masterdata/siswa');
        } else {
            $this->session->set_flashdata(
    ...
    public function list_spp()
    {
        ...
        foreach ($data as $spp) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $spp->ID_SPP . '" class="btn btn-sm btn-success" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
                <a href="' . base_url('masterdata/spp_del/') .  $spp->ID_SPP . '" class="btn btn-sm btn-warning tombol-hapus"  id="delete" name="delete"><i class="fas fa-trash"></i></a>
                </td>';
            echo '</tr>';
             echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function list_kelas()
    {
        ...
        foreach ($data as $kelas) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $kelas->ID_KELAS . '" class="btn btn-sm btn-success" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
                <a href="' . base_url('masterdata/kelas_del/') .  $kelas->ID_KELAS . '" class="btn btn-sm btn-warning tombol-hapus"  id="delete" name="delete"><i class="fas fa-trash"></i></a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    // //    cek apakah data di tabel terkait masih ada yang menggunakan nilai ID ini
    //     $cek = $this->db->get_where('tbl_pembayaran', ['id_kelas' => $id]);
    //     if ($cek->num_rows() >0) {
    //         // ada data terkait, rollback transaksi dan hentikan proses penghapusan 
    //         $this->db->trans_rollback();
    //         $this->session->set_flashdata(
    ...
    public function list_jurusan()
    {
        ...
        foreach ($data as $jurusan) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $jurusan->ID_JURUSAN . '" class="btn btn-sm btn-success" data-popup="tooltip" data-placement="top" title="Edit Data">
                <i class="fas fa-edit"></i></a>
                <a href="' . base_url('masterdata/jurusan_del/') .  $jurusan->ID_JURUSAN . '" class="btn btn-sm btn-warning tombol-hapus"  id="delete" name="delete"><i class="fas fa-trash"></i></a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    public function jurusan_edit()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->db->affected_rows() > 0) {
                ...
                $this->session->set_flaashdata('message', '<div class="alert alert-success" role"alert".Data diubah</div>');
                redirect('masterdata/jurusan');
            } else {
                return false;
            }
