...
<aside class="main-sidebar sidebar bg-black elevation-4">
    <!-- Brand Logo -->
                ...
                <?php if ($title == 'Home') : ?>
                    ...
                    <?php if ($this->session->userdata('level') ==  'Admin') : ?>
                        <?php if ($title == 'Data Petugas' || $title == 'Data Siswa' || $title == 'Data SPP' || $title == 'Data Kelas' || $title == 'Data Jurusan') : ?>
                            ...
                            <li class="nav-header p-2 text-white">Transaksi</li>
                            <?php if ($title == 'Entri Transaksi Pembayaran') : ?>
                                ...
                                <?php if ($title == 'Lihat History Pembayaran') : ?>
                                    ...
                                    <li class="nav-header p-2 text-white">Laporan</li>
                                    ...
                                    <?php elseif ($this->session->userdata('level') == 'Petugas') : ?>
                                        ...
                                        <?php if ($title == 'Entri Transaksi Pembayaran') : ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <?php endif ?>
                                                <li class="nav-header p-2 text-white"></li>
                                                <li class="nav-item text-white">
