    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-6 my-3">
                <h3 class="oleo-font">APLIKASI SPP</h3>
                <div class="row">
                    <div class="col-lg">
            ...
            <div class="col-lg-6 my-3">
                ...
                <div class="row text-left my-2">
                    ...
                    <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=+6282257390370">+62 822 2739 0370</a></div>
                </div>
                ...
                <div class="row text-left my-2">
                    ...
                    <div class="col-lg-8">Dusun Krajan,Desa Umbulsari Kecamatan Umbulsari Kabupaten Jember Provinsi Jawa Timur</div>
                </div>
            </div>
        </div>
    </div>
